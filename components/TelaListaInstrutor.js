...
export function TelaListaInstrutor({navigation, route}) {
  ...
  return (
    <View style={styles.container}>
      ...
      />
      <Button title="Contratar" onPress={() => navigation.navigate('TelaEditarUsuario', { idusuarios: route.params.idusuarios })} />
